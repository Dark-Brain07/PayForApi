    ...
    <footer className="border-t border-brand-border bg-brand-black mt-20">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-4">
          <Link href="/" aria-label="Pay For API Home" className="flex items-center space-x-3 hover:scale-105 transition-transform duration-300">
            <img src="/logo.png" alt="Pay For API Logo" width={60} height={60} loading="lazy" className="w-16 h-16 object-contain drop-shadow-xl" />
