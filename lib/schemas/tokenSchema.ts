...
export const tokenSchema = z.object({
  ...
  contractAddress: z.string().trim().toLowerCase().regex(EVM_ADDRESS_REGEX, "Invalid EVM address"),
 ...
 * @returns {z.SafeParseReturnType<TokenData, TokenData>} Zod safe parse result object
 */
