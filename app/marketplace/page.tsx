        ...
        <div className="mt-16">
          ...
          {isLoadingCommunity ? (
            ...
            <div aria-live="polite" className="w-full relative overflow-hidden text-center py-20 px-6 border border-[#1E293B] bg-gradient-to-b from-[#0F172A] to-[#0B0E14] rounded-2xl flex flex-col items-center justify-center group transition-all duration-300 hover:border-[#334155] shadow-lg">
              ...
              <a href="/dashboard" target="_blank" rel="noopener noreferrer" aria-label="Launch Creator Dashboard in a new tab" className="relative z-10 inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-brand-yellow/10 hover:bg-brand-yellow/20 border border-brand-yellow/20 rounded-xl text-brand-yellow font-bold transition-all duration-300 hover:shadow-[0_0_20px_rgba(250,204,21,0.15)]">
                Launch Creator Dashboard
                <svg aria-hidden="true" className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                </svg>
              </a>
            </div>
          )}
