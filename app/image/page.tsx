    ...
    <div aria-live="polite" aria-busy="true" className="flex flex-col items-center justify-center gap-6 w-full py-12">
      <div className="relative flex items-center justify-center w-28 h-28">
        ...
        <div className="absolute inset-1 rounded-full bg-[#0F141C] flex items-center justify-center z-10 shadow-inner">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" className="animate-pulse">
  ...
  return (
    <div className="relative group inline-block">
      ...
      {isLoaded && (
        ...
        >
          {isDownloading ? (
             <svg aria-hidden="true" className="w-5 h-5 animate-spin text-brand-yellow" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
             </svg>
          ) : (
             <svg aria-hidden="true" className="w-5 h-5 group-hover:text-brand-yellow transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div key={item.id} className="flex justify-center">
            <div className="max-w-[95%] sm:max-w-[80%] w-full flex flex-col items-center">
              ...
              <div className="flex justify-center items-center w-full min-h-[200px] rounded-xl relative">
                {item.error ? (
                   <div role="alert" aria-live="polite" className="text-red-500 font-bold p-4 text-center bg-red-500/10 rounded-xl w-full border border-red-500/20">{item.error}</div>
                ) : item.imageUrl ? (
