...
const CodeBlock = ({ code, language = "json" }: { code: string, language?: string }) => (
  <div tabIndex={0} className="relative group rounded-xl overflow-hidden bg-[#050505] border border-[#1E293B] shadow-inner my-6">
    <div className="flex justify-between items-center px-4 py-2 bg-[#0F141C] border-b border-[#1E293B]">
      ...
      <button onClick={() => navigator.clipboard.writeText(code)} aria-label={`Copy ${language} code block`} title="Copy Code" className="text-xs text-[#94A3B8] hover:text-white transition-colors">Copy</button>
    </div>
      ...
      <div className="flex flex-col md:flex-row max-w-7xl mx-auto w-full px-4 md:px-16 py-12 gap-12 relative flex-grow">
        ...
        <div className="md:hidden mb-8 relative group z-20">
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-5 text-brand-yellow">
            <svg title="Dropdown Icon" className="fill-current h-5 w-5 drop-shadow-[0_0_8px_rgba(245,197,24,0.5)]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Dropdown Menu</title><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
          </div>
        </div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-gradient-to-br from-[#002A1A] to-[#0A0D12] border border-[#00E676]/30 rounded-2xl p-8 mb-8 shadow-xl relative overflow-hidden">
                ...
                <div className="bg-[#050505] border border-[#1E293B] rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between relative z-10 gap-3">
                  ...
                  <a href="https://celoscan.io/address/0x5a8d4Bf8989c65e3964E8e6cD82FC585EbC1fF7a" target="_blank" rel="noopener noreferrer" aria-label="Open Celo Explorer in new tab" title="View on Celo Explorer" className="text-[#00E676] text-sm font-bold hover:underline shrink-0">View on Explorer ↗</a>
                </div>
              </div>
            </div>
          )}
