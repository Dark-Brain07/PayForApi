...
const EmptyStateIcon: React.FC = () => (
  <svg role="img" title="Empty State Dashboard" className="w-12 h-12 text-[#334155] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="p-6 bg-[#0F172A] border border-[#1E293B] rounded-2xl">
            ...
            <p aria-live="polite" className="text-3xl font-black text-white">{loadingEndpoints ? <span role="status" aria-busy="true" aria-live="polite" className="animate-pulse opacity-50">...</span> : (apis?.length ?? 0)}</p>
          </div>
          <div className="p-6 bg-[#0F172A] border border-[#1E293B] rounded-2xl">
