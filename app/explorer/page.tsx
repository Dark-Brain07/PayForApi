        ...
        <div className="card overflow-hidden border border-[#1E293B] shadow-lg flex flex-col">
          <div className="p-6 border-b border-[#1E293B] bg-[#0B0E14] flex justify-between items-center shrink-0">
            ...
            <div className="flex gap-3 items-center">
              <button onClick={() => window.location.reload()} disabled={leaderboardLoading} className="text-xs text-[#94A3B8] hover:text-white flex items-center gap-1 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"><span aria-hidden="true">↻</span> Refresh</button>
