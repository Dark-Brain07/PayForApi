...
export default function Explorer(): React.JSX.Element {
  const [stats, setStats] = useState<ExplorerStats>({ revenueUsdm: "0.00", revenueApic: "0.00" });
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div className="card p-8 border border-[#1E293B] shadow-xl relative overflow-hidden group hover:border-[#334155] transition-all flex flex-col items-center justify-center text-center">
          ...
          <div className="absolute -top-10 -right-10 opacity-5">
            <svg title="Revenue Icon" role="presentation" aria-hidden="true" focusable="false" width="200" height="200" viewBox="0 0 24 24" fill="currentColor" className="text-[#00E676]"><title>Revenue Icon</title><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>
          </div>
        ...
        <div className="card p-8 border border-[#1E293B] shadow-xl relative overflow-hidden group hover:border-[#334155] transition-all flex flex-col items-center justify-center text-center">
          ...
          <div className="absolute -top-10 -right-10 opacity-5">
            <svg aria-hidden="true" width="200" height="200" viewBox="0 0 24 24" fill="currentColor" className="text-[#F5C518]"><title>APIC Revenue Icon</title><path d="M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>
          </div>
          ...
          <div className="p-8 text-center text-[#94A3B8] bg-brand-elevated flex-grow flex flex-col justify-center">
            ...
            <div className="flex flex-col xl:flex-row justify-center items-center gap-4 w-full">
              ...
              >
                ...
                <svg role="presentation" aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
              </button>
            </div>
          </div>
        </div>
                  ...
                  (topDonors || []).map((donor, idx) => (
                    <tr key={idx} className="hover:bg-[#1E293B]/50 transition-colors group">
                      ...
                      <td className="py-4 px-6">
                        <a role="link" href={`https://celoscan.io/address/${donor.address}`} target="_blank" rel="noopener noreferrer" aria-label={`View donor address ${donor.address} on Celo explorer`} title={donor.address} className="text-[#94A3B8] font-mono text-sm group-hover:text-white transition-colors">
